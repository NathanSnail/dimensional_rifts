...
local mod_id = "dimensional_rifts" -- This should match the name of your mod's folder.
mod_settings_version = 1 -- This is a magic global that can be used to migrate settings to new mod versions. call mod_settings_get_version() before mod_settings_update() to get the old value.
---@type mod_setting[]
mod_settings = {
	{
		id = "spawn_chance",
		ui_name = "Rift spawn chance",
		ui_description = "How likely a rift is to spawn (as a percentage)",
		value_default = "50",
		text_max_length = 5,
